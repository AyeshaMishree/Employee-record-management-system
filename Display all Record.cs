...
{
    public partial class Display_all_Record : Form
    {
       
        public Display_all_Record()
        {
            InitializeComponent();
        }
    void Getemployee()
    ...
    private void btnclosegridview_Click(object sender, EventArgs e)
        {
        ...
        int a = 0;
        int row = 0;
        private void Display_all_Record_Load(object sender, EventArgs e)
        {
